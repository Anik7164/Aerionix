...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['insert'])) {
    ...
    $result = $conn->query("SELECT MAX(schedule_id) AS max_id FROM schedules");
    $row = $result->fetch_assoc();
    $new_schedule_id = $row['max_id'] + 1;

    $sql = "INSERT INTO schedules (schedule_id,flight_id, departure_time, arrival_time) VALUES ('$new_schedule_id','$flight_id', '$departure_time', '$arrival_time')";
    $conn->query($sql);
